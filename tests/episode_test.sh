...
function un_soustitre_correspond_sil_a_le_meme_nom_que_lepisode() {
...
function un_soustitre_peut_correspondre_quimporte_le_format_de_lepisode() {
  assertion__successful \
...
function un_soustitre_peut_ne_pas_correspond_du_tout() {
  assertion__failing \
